...
class Solution {
    ...
    getLeftHeight(root){
        ...
        // return this.getLeftHeight(root.left) + 1; 
                return Math.max(this.getLeftHeight(root.left), this.getLeftHeight(root.right)) + 1;
    ...
    getRightHeight(root){
        ...
        // return this.getRightHeight(root.right) + 1; 
                return Math.max(this.getRightHeight(root.left), this.getRightHeight(root.right)) + 1;
