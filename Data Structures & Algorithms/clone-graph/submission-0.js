...
class Solution {
    ...
    cloneGraph(node) {
        ...
        //     }
        // }
        function stepTwo(node, visited = new Set()) {  // Pass visited set as parameter
            console.log(node.val, visited)
            if(visited.has(node)) return;  // Only check visited
            ...
            for(let neighbor of node.neighbors) {  // Can use for...of here
                ...
                stepTwo(neighbor, visited);  // Pass visited set
            }
        }
