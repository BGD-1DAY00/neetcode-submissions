class Solution {
    ...
    decode(str) {
        ...
        for(let i = 0; i < str.length; i++){
            ...
            secondCharNumber = i+1 < str.length && /[0-9]/.test(str[i+1]),
            thirdCharNumber = i+2 < str.length && /[0-9]/.test(str[i+2]),
            secondCharPound = i+1 < str.length && str[i+1] == "#",
            thirdCharPound = i+2 < str.length && str[i+2] == "#",
            fourthCharPound = i+3 < str.length && str[i+3] == "#"
